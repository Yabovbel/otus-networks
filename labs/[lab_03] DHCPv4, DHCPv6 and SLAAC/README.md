...
1. __Настройка базовой конфигурации на роутерах R1, R2 и коммуаторах S1 и S2__
	1. Выполняем действия, описанные в пункте 2 первой части лабораторной работы [/labs/%5Blab_03%5D%20DHCPv4,%20DHCPv6%20and%20SLAAC/README.md#ход-выполнения-лабораторной-работы]
